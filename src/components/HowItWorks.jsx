const HowItWorks = () => {
  ...
  return (
    <section className="mt-10 max-w-7xl shadow-lg border-2 rounded-lg mx-auto bg-linear-to-br from-cyan-200 via-white to-blue-300 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-16  px-4 ">
      ...
      <div className="grid grid-cols-1  md:grid-cols-3 gap-8">
        {steps.map((item) => (
          <div
            key={item.step}
            className="flex flex-col items-center text-center p-6 rounded-2xl border border-gray-300 dark:border-gray-700 shadow-sm hover:shadow-md transition"
          >
