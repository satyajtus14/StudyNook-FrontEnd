  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        <LuChevronDown
          className={`w-4 h-4 text-gray-500 dark:text-white transition-transform duration-200 ${
            open ? "rotate-180" : ""
          }`}
        />
      </button>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-3 px-2 py-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-olive-200">
                        {user.email}
                      </p>
                    </div>
                  </div>
